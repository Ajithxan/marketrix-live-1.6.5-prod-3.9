  ...
  render() {
    ...
    this.innerHTML = `
        ...
        <div id="focus-mode-frame-${this.participantId}" style="position:relative; overflow:hidden">
            ...
            <div class="mtx-hidden video-div" id="focus-mode-video-disable-${this.participantId}">
               <img class=" mtx-snpt-video-box" id="focus-mode-video-disable-image-${this.participantId}"  src="{{CDN_LINK}}assets/images/profile.png"/>
            </div>
