class VideoFrame extends HTMLElement {
  ...
  listen() {
    watch(() => {
      const mtxModeScreenComponent = document.getElementById(
        `mtx-mode-screen-component-${this.participantId}`
      );
      const focusModeScreenComponent = document.getElementById(
        `focus-mode-screen-component-${this.participantId}`
      );
