...
const CDNlink = `https://localhost/marketrix-live-1.6.5-prod-2.4/`; // `http://localhost/marketrix-live-1.6.5-prod-2.4/` //'http://localhost/creativehub/marketrix-live-1.6.5-prod-2.4/` // `http://localhost/marketrix-live-1.6.5-prod-2.4/`
console.log(CDNlink);
