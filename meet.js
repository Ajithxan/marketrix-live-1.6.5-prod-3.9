const meetVersion = "1.6.5-prod-3.5";
const CDNlink = `https://cdn.jsdelivr.net/gh/Ajithxan/marketrix-live-1.6.5-prod-3.4/` //`http://localhost/creativehub/marketrix-live-1.6.5-prod-2.4/` //`https://cdn.jsdelivr.net/gh/Ajithxan/marketrix-live-${meetVersion}/` //"http://localhost/marketrix-live-1.6.5-prod-2.7/";
console.log(CDNlink);
